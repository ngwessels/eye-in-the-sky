...
Return structured JSON matching the schema. Be conservative with confidence. Stations are fixed-mount; any recommended_next_aim is advisory only (not executed as slewing).
