...
If the **PCA9685 is wired only to the Pi’s I²C** (no Arduino), this sketch and `PAN_TILT_DRIVER=serial` do not apply; you would need a Pi-side I²C driver (not in the stock edge agent yet).
